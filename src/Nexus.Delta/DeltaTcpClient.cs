...
{
    /// <summary>
    /// 台达 DVP/AS 系列 PLC Modbus TCP 客户端。
    /// <para>继承 ModbusTcpClient，通过 DeltaAddress 解析台达 PLC 地址。</para>
    /// <para>默认字节序为 MidLittleEndian (CDAB)，与台达 PLC 一致。</para>
    /// </summary>
    public class DeltaTcpClient : ModbusTcpClient
    {
        ...
        public DeltaTcpClient(string ip, int port = 502, byte station = 1, int timeout = 5000, DeltaSeries series = DeltaSeries.DVP)
