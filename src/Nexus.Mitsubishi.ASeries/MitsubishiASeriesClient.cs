...
namespace Nexus.Mitsubishi.ASeries
{
    public class MitsubishiASeriesClient : SerialDeviceBase, IBatchReadWrite
    {
        ...
        public override OperateResult<bool> ReadBool(string address) => OperateResult<bool>.Failed("三菱 A 系列串口协议暂不支持，请使用 MC3E TCP 客户端");
        public override OperateResult<short> ReadInt16(string address) => OperateResult<short>.Failed("三菱 A 系列串口协议暂不支持");
        public override OperateResult<ushort> ReadUInt16(string address) => OperateResult<ushort>.Failed("三菱 A 系列串口协议暂不支持");
        public override OperateResult<int> ReadInt32(string address) => OperateResult<int>.Failed("三菱 A 系列串口协议暂不支持");
        public override OperateResult<uint> ReadUInt32(string address) => OperateResult<uint>.Failed("三菱 A 系列串口协议暂不支持");
        public override OperateResult<long> ReadInt64(string address) => OperateResult<long>.Failed("三菱 A 系列串口协议暂不支持");
        public override OperateResult<ulong> ReadUInt64(string address) => OperateResult<ulong>.Failed("三菱 A 系列串口协议暂不支持");
        public override OperateResult<float> ReadFloat(string address) => OperateResult<float>.Failed("三菱 A 系列串口协议暂不支持");
        public override OperateResult<double> ReadDouble(string address) => OperateResult<double>.Failed("三菱 A 系列串口协议暂不支持");
        public override OperateResult<string> ReadString(string address, ushort length) => OperateResult<string>.Failed("三菱 A 系列串口协议暂不支持");
        public override OperateResult<byte[]> ReadBytes(string address, ushort length) => OperateResult<byte[]>.Failed("三菱 A 系列串口协议暂不支持");
        public override OperateResult Write(string address, bool value) => OperateResult.Failed("三菱 A 系列串口协议暂不支持");
        public override OperateResult Write(string address, short value) => OperateResult.Failed("三菱 A 系列串口协议暂不支持");
        public override OperateResult Write(string address, ushort value) => OperateResult.Failed("三菱 A 系列串口协议暂不支持");
        public override OperateResult Write(string address, int value) => OperateResult.Failed("三菱 A 系列串口协议暂不支持");
        public override OperateResult Write(string address, uint value) => OperateResult.Failed("三菱 A 系列串口协议暂不支持");
        public override OperateResult Write(string address, long value) => OperateResult.Failed("三菱 A 系列串口协议暂不支持");
        public override OperateResult Write(string address, ulong value) => OperateResult.Failed("三菱 A 系列串口协议暂不支持");
        public override OperateResult Write(string address, float value) => OperateResult.Failed("三菱 A 系列串口协议暂不支持");
        public override OperateResult Write(string address, double value) => OperateResult.Failed("三菱 A 系列串口协议暂不支持");
        public override OperateResult Write(string address, string value) => OperateResult.Failed("三菱 A 系列串口协议暂不支持");
        public override OperateResult Write(string address, byte[] data) => OperateResult.Failed("三菱 A 系列串口协议暂不支持");
        ...
        public OperateResult<Dictionary<string, object?>> BatchRead(IEnumerable<string> addresses) => OperateResult<Dictionary<string, object?>>.Failed("三菱 A 系列串口协议暂不支持");
        ...
        public OperateResult<Dictionary<string, byte[]>> RandomRead(IEnumerable<string> addresses) => OperateResult<Dictionary<string, byte[]>>.Failed("三菱 A 系列串口协议暂不支持");
        ...
        public OperateResult BatchWrite(IEnumerable<KeyValuePair<string, object>> items) => OperateResult.Failed("三菱 A 系列串口协议暂不支持");
