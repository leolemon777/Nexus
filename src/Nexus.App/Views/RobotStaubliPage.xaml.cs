...
public partial class RobotStaubliPage : Page
{
    private RobotStaubliViewModel? _vm;

    public RobotStaubliPage()
    {
        InitializeComponent();
        _vm = ((App)Application.Current).Services.GetRequiredService<RobotStaubliViewModel>();
        DataContext = _vm;
        Loaded += OnPageLoaded;
