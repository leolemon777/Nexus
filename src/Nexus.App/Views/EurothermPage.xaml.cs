...
public partial class EurothermPage : Page
{
    private EurothermViewModel? _vm;

    public EurothermPage()
    {
        InitializeComponent();
        _vm = ((App)Application.Current).Services.GetRequiredService<EurothermViewModel>();
        DataContext = _vm;
        Loaded += OnPageLoaded;
