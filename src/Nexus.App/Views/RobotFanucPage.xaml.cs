...
public partial class RobotFanucPage : Page
{
    private RobotFanucViewModel? _vm;

    public RobotFanucPage()
    {
        InitializeComponent();
        _vm = ((App)Application.Current).Services.GetRequiredService<RobotFanucViewModel>();
        DataContext = _vm;
        Loaded += OnPageLoaded;
