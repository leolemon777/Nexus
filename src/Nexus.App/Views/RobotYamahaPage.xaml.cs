...
public partial class RobotYamahaPage : Page
{
    private RobotYamahaViewModel? _vm;

    public RobotYamahaPage()
    {
        InitializeComponent();
        _vm = ((App)Application.Current).Services.GetRequiredService<RobotYamahaViewModel>();
        DataContext = _vm;
        Loaded += OnPageLoaded;
