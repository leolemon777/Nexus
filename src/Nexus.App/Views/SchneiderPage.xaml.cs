...
public partial class SchneiderPage : Page
{
    private SchneiderViewModel? _vm;

    public SchneiderPage()
    {
        InitializeComponent();
        _vm = ((App)Application.Current).Services.GetRequiredService<SchneiderViewModel>();
        DataContext = _vm;
        Loaded += OnPageLoaded;
