...
public partial class SiemensPpiPage : Page
{
    private SiemensPpiViewModel? _vm;

    public SiemensPpiPage()
    {
        InitializeComponent();
        _vm = ((App)Application.Current).Services.GetRequiredService<SiemensPpiViewModel>();
        DataContext = _vm;
        Loaded += OnPageLoaded;
