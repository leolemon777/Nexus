...
public partial class BoschRexrothPage : Page
{
    private BoschRexrothViewModel? _vm;

    public BoschRexrothPage()
    {
        InitializeComponent();
        _vm = ((App)Application.Current).Services.GetRequiredService<BoschRexrothViewModel>();
        DataContext = _vm;
        Loaded += OnPageLoaded;
