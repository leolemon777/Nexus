...
public partial class FetchWritePage : Page
{
    private FetchWriteViewModel? _vm;

    public FetchWritePage()
    {
        InitializeComponent();
        _vm = ((App)Application.Current).Services.GetRequiredService<FetchWriteViewModel>();
        DataContext = _vm;
        Loaded += OnPageLoaded;
