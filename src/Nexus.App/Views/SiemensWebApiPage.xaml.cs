...
public partial class SiemensWebApiPage : Page
{
    private SiemensWebApiViewModel? _vm;

    public SiemensWebApiPage()
    {
        InitializeComponent();
        _vm = ((App)Application.Current).Services.GetRequiredService<SiemensWebApiViewModel>();
        DataContext = _vm;
        Loaded += OnPageLoaded;
