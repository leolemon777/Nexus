...
public partial class MitsubishiFxPage : Page
{
    private MitsubishiFxViewModel? _vm;

    public MitsubishiFxPage()
    {
        InitializeComponent();
        _vm = ((App)Application.Current).Services.GetRequiredService<MitsubishiFxViewModel>();
        DataContext = _vm;
        Loaded += OnPageLoaded;
