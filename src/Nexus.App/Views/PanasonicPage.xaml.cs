...
public partial class PanasonicPage : Page
{
    private PanasonicViewModel? _vm;

    public PanasonicPage()
    {
        InitializeComponent();
        _vm = ((App)Application.Current).Services.GetRequiredService<PanasonicViewModel>();
        DataContext = _vm;
        Loaded += OnPageLoaded;
