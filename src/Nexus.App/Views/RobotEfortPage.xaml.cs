...
public partial class RobotEfortPage : Page
{
    private RobotEfortViewModel? _vm;

    public RobotEfortPage()
    {
        InitializeComponent();
        _vm = ((App)Application.Current).Services.GetRequiredService<RobotEfortViewModel>();
        DataContext = _vm;
        Loaded += OnPageLoaded;
