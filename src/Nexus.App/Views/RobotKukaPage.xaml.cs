...
public partial class RobotKukaPage : Page
{
    private RobotKukaViewModel? _vm;

    public RobotKukaPage()
    {
        InitializeComponent();
        _vm = ((App)Application.Current).Services.GetRequiredService<RobotKukaViewModel>();
        DataContext = _vm;
        Loaded += OnPageLoaded;
