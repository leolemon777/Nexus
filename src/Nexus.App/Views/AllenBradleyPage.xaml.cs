...
public partial class AllenBradleyPage : Page
{
    private AllenBradleyViewModel? _vm;

    public AllenBradleyPage()
    {
        InitializeComponent();
        _vm = ((App)Application.Current).Services.GetRequiredService<AllenBradleyViewModel>();
        DataContext = _vm;
        Loaded += OnPageLoaded;
