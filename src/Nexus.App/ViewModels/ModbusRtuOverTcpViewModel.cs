...
public partial class ModbusRtuOverTcpViewModel : ProtocolViewModelBase
{
    ...
    public ModbusRtuOverTcpViewModel(PacketRecorderService packetRecorder)
        : base(packetRecorder, "modbus-rtu-over-tcp", ModbusPacketTransport.RtuOverTcp)
    {
        Address = "0";
        DataType = "Int16";
    }
    ...
    protected override OperateResult DoConnect()
    {
        ...
        var client = new ModbusRtuOverTcpClient(IpAddress, Port, SlaveId, Timeout);
    ...
    private void AttachClientEvents(ModbusRtuOverTcpClient client)
    {
    ...
    private void DetachClientEvents(ModbusRtuOverTcpClient client)
    {
        client.OnMessageSent -= OnMessageSent;
        client.OnMessageReceived -= OnMessageReceived;
        client.OnError -= OnClientError;
